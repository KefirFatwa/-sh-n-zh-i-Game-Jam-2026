...
func _actualizar_texto_cantidad_pollo(cantidad)->void:
	chicken_button.text = "x" + str(cantidad)
func _actualizar_texto_cantidad_noodle(cantidad)->void:
	noodle_button.text = "x" + str(cantidad)
func _actualizar_texto_cantidad_tacos(cantidad)->void:
	tacos_button.text = "x" + str(cantidad)
